...
for year in range(2000, 2019):
    print(str(year))
    word_count_file = f"hdp_data/HDP_results/{year}/final.topics"
    vocab_file = f"hdp_data/preprocessed_vector/vocab{year}.txt"
    topics_filename = f"hdp_data/doc_topics_words/{year}/topics_{year}.csv"
